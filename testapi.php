...
// Debugging
echo "Target directory path: " . $target_dir . "<br>";
echo "Temporary file path: " . $_FILES["imageFile"]["tmp_name"] . "<br>";
echo "Target file path: " . $target_file . "<br>";
echo "Real path of target directory: " . realpath($target_dir) . "<br>";
...
if (!is_dir($target_dir)) {
    ...
    echo "Target directory exists and is writable.<br>";
}
...
if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($_FILES["imageFile"]["tmp_name"], $target_file)) {
        ...
        if ($conn->connect_error) {
            ...
            $sql = "INSERT INTO images (image, upload_time) VALUES ('$file_path', '$upload_time')";
        ...
        echo "Debug info: " . error_get_last()["message"] . "<br>";
    }
}
